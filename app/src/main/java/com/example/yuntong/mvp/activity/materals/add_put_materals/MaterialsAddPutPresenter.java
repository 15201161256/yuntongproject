...
public class MaterialsAddPutPresenter implements MaterialsAddPutContract.presenter {

    private Context context;
    private MaterialsAddPutContract.View view;

    public MaterialsAddPutPresenter(Context context, MaterialsAddPutContract.View view) {
