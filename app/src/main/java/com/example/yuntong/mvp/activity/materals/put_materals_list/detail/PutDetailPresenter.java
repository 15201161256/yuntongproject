...
public class PutDetailPresenter implements PutDetailContract.presenter {

    private Context context;
    private PutDetailContract.View view;

    public PutDetailPresenter(Context context, PutDetailContract.View view) {
