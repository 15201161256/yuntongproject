 ...
 * @Describe 材料出库记录列表
 */
public class MateralsOutListActivity extends BaseActivity implements MaterialsOutListContract.View {
    ...
    private MateralOutAdapter adapter;
    private List<MaterialsTypeBean.RowsBean> outBeans = new ArrayList<>();
    private BaseEntry<MaterialPutBean> listBean2;
    private View emptyView;
    private int page = 1;
    private MaterialsOutListPresenter presenter;
    ...
    protected int getLayoutId() {
        return R.layout.activity_materals_out;
    }
    ...
    protected void initView() {
        ...
        presenter = new MaterialsOutListPresenter(mActivity, this);
    }

    @Override
    protected void initData() {
        presenter.getList(page, 10, ApiAddress.materialId, "1");
        Init_Refresh();
    }
    ...
    private void initRcDta() {
        if (adapter == null) {
            adapter = new MateralOutAdapter(mActivity, outBeans);
            //5，给recyclerView设置空布局
            if (outBeans == null || outBeans.size() == 0) {
            ...
            adapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
                ...
                public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                    MaterialsTypeBean.RowsBean rowsBean = outBeans.get(position);
                    ApiAddress.material_Out_Id = rowsBean.getId() + "";
                    startActivity(new Intent(mActivity, OutDetailActivity.class));
                }
            });
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.add_contract_rl:
                startActivityForResult(new Intent(mActivity, MateralOutAddActivity.class), 200);
                break;
        }
    }
    ...
    public void getData(BaseEntry<MaterialsTypeBean> baseEntry) {
        outBeans.addAll(baseEntry.getData().getRows());
