...
import com.example.yuntong.mvp.activity.materals.put_materals_list.detail.PutDetailPresenter;
 ...
 * @Describe 出库详情
 */
public class OutDetailActivity extends BaseActivity implements OutDetailContract.View {
    ...
    TextView remarkTv;
    private OutDetailPresenter presenter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        presenter = new OutDetailPresenter(mActivity, this);
        presenter.getMaterialsDetailData(ApiAddress.PUT_DETAIL + ApiAddress.material_Out_Id);
    }
