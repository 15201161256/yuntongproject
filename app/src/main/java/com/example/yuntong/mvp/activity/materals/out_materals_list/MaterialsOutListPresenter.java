...
public class MaterialsOutListPresenter implements MaterialsOutListContract.presenter {

    private Context context;
    private MaterialsOutListContract.View view;

    public MaterialsOutListPresenter(Context context, MaterialsOutListContract.View view) {
